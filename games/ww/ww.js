...
(function () {
  /* Заливки плиток - буквальные hex листа, по кругу. Чернила везде, белый
     только на фиолетовом 6B42FD (5.49:1) и оливковом 5D614B (6.41:1).

     Два цвета листа в этот список НЕ входят: коралловый FF4E00 (с чернилами
     4.48:1, с белым 3.31) и сине-фиолетовый 886BF3 (3.85 / 3.86) - ни одна
     пара не дотягивает до 4.5:1, то есть мелкий текст на них не читается.
     Они остаются цветами бренда для крупных надписей и акцентов, но плитка
     со словом ими не красится. Коэффициенты посчитаны формулой WCAG на
     живых значениях, а не на глаз. */
  var FILLS = [
    ['#3F9FFF', '#24282C'], ['#F3DF6B', '#24282C'], ['#FF8C3A', '#24282C'], ['#6B42FD', '#FFFFFF'],
    ['#49F6F0', '#24282C'], ['#FFE44D', '#24282C'], ['#D3F36B', '#24282C'], ['#A3A48D', '#24282C'],
