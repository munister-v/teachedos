/* Спільне ядро текстових помічників для генераторів вправ.
   ...
   Другий читач (teacher-tools-app.js, Tools Hub) прибраний 09.09.2026 -
   лишився один, board-app.js, але порядок підключення все одно важливий:
   цей файл має йти ПЕРЕД ним, той покладається на ці імена в глобальній
   області. */
